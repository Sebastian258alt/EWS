...
const TRANSLATIONS = {
  en: {
    ...
    // Profile extras
    editProfile: '✏️ Edit Profile', quizzesTaken: 'Quizzes Taken', pronPractice: 'Pron. Practice',
    memberSince: 'Member Since', langBadge: '🌐 EN', 
  ...
  pt: {
    ...
    // Profile extras
    editProfile: '✏️ Editar Perfil', quizzesTaken: 'Quizzes Feitos', pronPractice: 'Prática de Pronúncia',
    memberSince: 'Membro Desde', langBadge: '🌐 PT',
    // Admin translations (new)
...
// ─── PRONUNCIATION DATA ──────────────────────────────────
const PRON_WORDS = [
  {w:'Hello',ipa:'/həˈloʊ/',m:'A common greeting / Cumprimento comum'},
  {w:'Pronunciation',ipa:'/prəˌnʌnsiˈeɪʃən/',m:'The way a word is spoken / Como se pronuncia uma palavra'},
  {w:'Beautiful',ipa:'/ˈbjuːtɪfl/',m:'Pleasing to the senses / Agradável aos sentidos'},
  {w:'Comfortable',ipa:'/ˈkʌmftəbl/',m:'At ease; not tight / À vontade; confortável'},
  {w:'Vocabulary',ipa:'/vəˈkæbjʊleri/',m:'All the words you know / Todo o vocabulário que conheces'},
  {w:'Wednesday',ipa:'/ˈwenzdeɪ/',m:'Middle day of the week / O meio da semana'},
  {w:'February',ipa:'/ˈfebrʊeri/',m:'The second month / O segundo mês'},
  {w:'Library',ipa:'/ˈlaɪbreri/',m:'A place with books / Biblioteca'},
  {w:'Particularly',ipa:'/pəˈtɪkjʊləli/',m:'Especially / Em especial, particularmente'},
  {w:'Thoroughly',ipa:'/ˈθʌrəli/',m:'Completely / Completamente, a fundo'},
  {w:'Entrepreneur',ipa:'/ˌɒntrəprəˈnɜː/',m:'A business founder / Empreendedor'},
  {w:'Vegetable',ipa:'/ˈvedʒtəbl/',m:'An edible plant / Planta comestível, vegetal'},
  {w:'Athlete',ipa:'/ˈæθliːt/',m:'A sports person / Atleta, desportista'},
  {w:'Clothes',ipa:'/kloʊðz/',m:'What you wear / Roupas, vestuário'},
  {w:'Receipt',ipa:'/rɪˈsiːt/',m:'A proof of purchase / Recibo de compra'},
  {w:'Colonel',ipa:'/ˈkɜːnl/',m:'A military officer / Coronel (militar)'},
  {w:'Worcestershire',ipa:'/ˈwʊstəʃɪə/',m:'A county in England / Condado de Inglaterra'},
  {w:'Chaos',ipa:'/ˈkeɪɒs/',m:'Complete disorder / Caos, desordem total'},
  {w:'Choir',ipa:'/ˈkwaɪər/',m:'A singing group / Coro, grupo vocal'},
  {w:'Queue',ipa:'/kjuː/',m:'A line of waiting people / Fila de espera'},
  {w:'Scissors',ipa:'/ˈsɪzərz/',m:'A cutting tool / Tesoura'},
  {w:'Psychology',ipa:'/saɪˈkɒlədʒi/',m:'Study of the mind / Psicologia'},
  {w:'Pneumonia',ipa:'/njuːˈmoʊniə/',m:'A lung illness / Pneumonia'},
  {w:'Sword',ipa:'/sɔːrd/',m:'A long blade / Espada'},
  {w:'Rhythm',ipa:'/ˈrɪðəm/',m:'A regular beat / Ritmo'},
  {w:'Debt',ipa:'/det/',m:'Money owed / Dívida (o B é mudo!)'},
  {w:'Island',ipa:'/ˈaɪlənd/',m:'Land in water / Ilha (o S é mudo!)'},
  {w:'Knowledge',ipa:'/ˈnɒlɪdʒ/',m:'What you know / Conhecimento'},
  {w:'Conscience',ipa:'/ˈkɒnʃəns/',m:'Inner moral sense / Consciência'},
  {w:'Throughout',ipa:'/θruːˈaʊt/',m:'From start to finish / Em todo, ao longo de'},
];

const MINIMAL_PAIRS = [
  {a:'Ship',b:'Sheep',pa:'/ʃɪp/',pb:'/ʃiːp/',note:'Short /ɪ/ vs Long /iː/ — erro muito comum! (navio vs ovelha)'},
  {a:'Bit',b:'Beat',pa:'/bɪt/',pb:'/biːt/',note:'Short /ɪ/ vs Long /iː/ — ouve com atenção (bocado vs bater)'},
  {a:'Full',b:'Fool',pa:'/fʊl/',pb:'/fuːl/',note:'Short /ʊ/ vs Long /uː/ (cheio vs idiota)'},
  {a:'Live',b:'Leave',pa:'/lɪv/',pb:'/liːv/',note:'Short /ɪ/ vs Long /iː/ (viver vs sair)'},
  {a:'Think',b:'Sink',pa:'/θɪŋk/',pb:'/sɪŋk/',note:'/θ/ vs /s/ — língua entre os dentes! (pensar vs lava-loiça)'},
  {a:'This',b:'Dis',pa:'/ðɪs/',pb:'/dɪs/',note:'/ð/ voiced — ponta da língua entre os dentes (este vs dis)'},
  {a:'Wine',b:'Vine',pa:'/waɪn/',pb:'/vaɪn/',note:'/w/ vs /v/ — posição dos lábios importa! (vinho vs videira)'},
  {a:'West',b:'Best',pa:'/west/',pb:'/best/',note:'/w/ vs /b/ — lábios arredondados para /w/ (oeste vs melhor)'},
  {a:'Cat',b:'Cut',pa:'/kæt/',pb:'/kʌt/',note:'/æ/ vs /ʌ/ — abertura da boca diferente (gato vs cortar)'},
  {a:'Bad',b:'Bed',pa:'/bæd/',pb:'/bed/',note:'/æ/ vs /e/ — muito confundidos! (mau vs cama)'},
  {a:'Rice',b:'Lice',pa:'/raɪs/',pb:'/laɪs/',note:'/r/ vs /l/ — cuidado, sons distintos! (arroz vs piolhos)'},
  {a:'Right',b:'Light',pa:'/raɪt/',pb:'/laɪt/',note:'/r/ vs /l/ — treina bem este par! (certo vs luz)'},
  {a:'Pan',b:'Ban',pa:'/pæn/',pb:'/bæn/',note:'/p/ vs /b/ — voz vs sem voz (frigideira vs proibição)'},
  {a:'Coat',b:'Goat',pa:'/koʊt/',pb:'/goʊt/',note:'/k/ vs /g/ — voz vs sem voz (casaco vs cabra)'},
  {a:'Pull',b:'Bull',pa:'/pʊl/',pb:'/bʊl/',note:'/p/ vs /b/ inicial (puxar vs touro)'},
  {a:'Fan',b:'Van',pa:'/fæn/',pb:'/væn/',note:'/f/ vs /v/ — dentes no lábio inferior! (fã vs carrinha)'},
];

const TONGUE_TWISTERS = [
  {text:'She sells seashells by the seashore.',note:'Focus on /s/ vs /ʃ/ — /s/ = sibilante, /ʃ/ = "sh" (Pratica /s/ vs /ʃ/)'},
  {text:'Peter Piper picked a peck of pickled peppers.',note:'Perfect /p/ practise — lábios juntos e soltos com força! (Pratica o /p/)'},
  {text:'How much wood would a woodchuck chuck?',note:'Master /w/ and /ʧ/ — lábios arredondados para /w/! (Domina o /w/ e o /tʃ/)'},
  {text:'The thirty-three thieves thought that they thrilled the throne.',note:'Pure /θ/ workout — língua entre os dentes! Vai devagar! (Treino do TH)'},
  {text:'Red lorry, yellow lorry, red lorry, yellow lorry.',note:'/r/ vs /l/ — não os confundas! (O temido par /r/ e /l/)'},
  {text:'I scream, you scream, we all scream for ice cream.',note:'Fun vowels and consonant clusters (Vogais e grupos consonânticos)'},
  {text:'Unique New York, unique New York, you know you need unique New York.',note:'/juː/ sound and /n/ clusters — lábios arredondados para /juː/! (Som /juː/)'},
  {text:'Betty Botter bought some butter but the butter was bitter.',note:'/b/ and /t/ alternation — boca fechada para /b/, língua nos dentes para /t/! (Alterna /b/ e /t/)'},
  {text:'Which witch is which? The wicked witch switched wristwatch.',note:'/w/ vs /wɪtʃ/ — atenção ao grupo "wh" (Pratica o /w/ e /tʃ/)'},
  {text:'Six slippery snails slid slowly seaward.',note:'/sl/ and /s/ clusters — clusters iniciais difíceis! (Grupos consonânticos com /s/)'},
  {text:'The big black bug bit the big black bear.',note:'/b/ vs /bl/ clusters — força nos lábios! (Clusters com /bl/)'},
  {text:'Lesser leather never weathered wetter weather better.',note:'/ð/ and /θ/ — TH voiced vs voiceless in one sentence! (Dois tipos de TH juntos)'},
];

const DIFFICULT_SOUNDS = [
  {sound:'TH /θ/ (surdo)',eg:'think, three, throat, bath, both',tip:'Ponta da língua ENTRE os dentes superiores e inferiores. Sopra suavemente. SEM vibração! / Tongue TIP between teeth, blow gently.',wrong:'Muitos dizem /t/ ou /s/. Ex: "sink" em vez de "think"'},
  {sound:'TH /ð/ (sonoro)',eg:'this, that, the, breathe, those',tip:'Mesma posição que /θ/ MAS com vibração na garganta. Sente a vibração! / Same as /θ/ but add voice — feel the buzz!',wrong:'Costuma ser dito como /d/. Ex: "dis" em vez de "this"'},
  {sound:'W /w/',eg:'wine, water, word, work, world',tip:'Arredonda os lábios como para um beijo. Começa com /u/ e abre. Curto! / Round lips like kissing, start /u/ then open.',wrong:'Muitos dizem /v/. Ex: "vine" em vez de "wine"'},
  {sound:'V /v/',eg:'very, voice, live, love, video',tip:'Dentes superiores no lábio INFERIOR. Adiciona vibração. Não é só ar! / Upper teeth on lower lip, add vibration.',wrong:'Confundido com /b/. Ex: "berry" em vez de "very"'},
  {sound:'H /h/',eg:'hello, happy, hold, have, here',tip:'Só expira. Sem vibração. Leve! Nenhum som antes da vogal. / Just breathe out. No vibration. Light and breezy!',wrong:'Muitos omitem o H. Ex: "ello" em vez de "hello"'},
  {sound:'R /r/',eg:'red, right, run, drive, road',tip:'Ponta da língua levantada, sem tocar em nada. Lábios arredondados. / Tongue tip raised, not touching. Lips rounded.',wrong:'Não vibres como o R português/espanhol. O R inglês é suave.'},
  {sound:'Short /ɪ/ vs Long /iː/',eg:'/ɪ/ bit, sit, hit — /iː/ beat, seat, heat',tip:'Curto /ɪ/: boca semi-aberta, relaxada. Longo /iː/: lábios esticados como um sorriso! / Short = relaxed, long = smile wide.',wrong:'Dizer "ship" com /iː/ diz "sheep" — são palavras diferentes!'},
  {sound:'Short /ʌ/ vs /æ/',eg:'/ʌ/ cup, bus, fun — /æ/ cat, bad, map',tip:'/ʌ/: boca pouco aberta no centro. /æ/: boca bem aberta para baixo. / /ʌ/ = center mouth, /æ/ = jaw drops wide.',wrong:'Confundir "cup" com "cap", "but" com "bat" — presta atenção à abertura!'},
  {sound:'Final consonants -ed',eg:'walked /t/, played /d/, wanted /ɪd/',tip:'Após surdo (p,k,f,s): pronúncia /t/. Após sonoro (b,g,v): /d/. Após t/d: /ɪd/. / After voiceless: /t/, voiced: /d/, t/d: /ɪd/.',wrong:'Dizer "walkED" com vogal. Correcto: "walkt" não "walk-ED"'},
  {sound:'Silent letters',eg:'knife /naɪf/, know /noʊ/, write /raɪt/, hour /aʊər/',tip:'Inglês tem muitas letras mudas! K antes de N, W antes de R, H inicial. / Many silent letters — K before N, W before R!',wrong:'Pronunciar o K em knife, o W em write, o H em hour — tudo mudo!'},
];
...
// ─── ABOUT ME DATA ───────────────────────────────────────
const ABOUT_DATA = {
  name: 'Sebastião Zefanias Nhamuneque Junior',
  nickname: 'Flow Creator',
  role: {
    en: 'English Teacher · Translator · Web Developer · App Creator',
    pt: 'Professor de Inglês · Tradutor · Programador Web · Criador da App'
  },
  location: 'Maputo / Matola, Mozambique 🇲🇿',
  email: 'nhamoneques@gmail.com',
  email2: 'sebastianjunior@outlook.com',
  phone: '+258 845 713 020',
  phone2: '+258 871 313 059',
  whatsapp: '+258845713020',
  website: 'https://english-with-sebastian.vercel.app',
  summary: {
    en: 'Results-driven English Teacher, Translator, Web Developer, and Customer Service Professional with over 6 years of experience in language education and communication. Expertly combines linguistic mastery with AI integration and web development to build dynamic learning platforms.',
    pt: 'Professor de Inglês, Tradutor, Programador Web e Profissional de Serviço ao Cliente com mais de 6 anos de experiência em educação linguística. Combina domínio linguístico com integração de IA e desenvolvimento web para criar plataformas de aprendizagem dinâmicas.'
  },
  education: [
    {
      en: {degree: 'Bachelor\'s Degree — Translation & Interpretation (EN↔PT)', school: 'Universidade Eduardo Mondlane (UEM)', year: '2022–Present', note: 'Final-year student. Specialising in English–Portuguese linguistics, intercultural communication, and academic translation.'},
      pt: {degree: 'Licenciatura — Tradução e Interpretação (EN↔PT)', school: 'Universidade Eduardo Mondlane (UEM)', year: '2022–Presente', note: 'Estudante finalista. Especialização em linguística inglês-português, comunicação intercultural e tradução académica.'}
    }
  ],
  experience: [
    {
      en: {title: 'Web Developer, Founder & Manager', org: 'English With Sebastian (EWS)', period: '2026–Present', desc: 'Conceptualized, built, and manage the official web platform and app at english-with-sebastian.vercel.app. Integrated modern web frameworks to build a responsive digital learning ecosystem. Oversees full-stack operations and digital content delivery to optimize student engagement.'},
      pt: {title: 'Programador Web, Fundador & Gestor', org: 'English With Sebastian (EWS)', period: '2026–Presente', desc: 'Conceptualizou, construiu e gere a plataforma web e app oficial em english-with-sebastian.vercel.app. Integrou frameworks web modernos para criar um ecossistema digital de aprendizagem responsivo. Supervisiona operações full-stack e entrega de conteúdo digital.'}
    },
    {
      en: {title: 'English Teacher (Levels 1–4)', org: 'Consultoria Linguística e Coaching Isac (CLCI) — Maputo', period: '~4+ Years', desc: 'Delivered structured English lessons from beginner to intermediate level. Improved student performance through interactive teaching methods. Designed lesson plans, exercises and assessments aligned with curriculum objectives. Managed classroom environments ensuring engagement and discipline.'},
      pt: {title: 'Professor de Inglês (Níveis 1–4)', org: 'Consultoria Linguística e Coaching Isac (CLCI) — Maputo', period: '~4+ Anos', desc: 'Ministrou aulas de inglês estruturadas do nível iniciante ao intermédio. Melhorou o desempenho dos estudantes através de métodos interactivos. Desenvolveu planos de aula, exercícios e avaliações alinhados com os objectivos curriculares.'}
    },
    {
      en: {title: 'Enumerator / Data Collector (Inquiridor)', org: 'Centro de Análise Política (CAP)', period: '2021–2022', desc: 'Collected primary data from residents in Maputo City and Province for mobility studies. Administered structured questionnaires with accuracy and professionalism. Ensured data quality and reliability for analysis by research teams.'},
      pt: {title: 'Enumerador / Recolhedor de Dados (Inquiridor)', org: 'Centro de Análise Política (CAP)', period: '2021–2022', desc: 'Recolheu dados primários de residentes em Maputo Cidade e Província para estudos de mobilidade. Administrou questionários estruturados com rigor e profissionalismo. Garantiu a qualidade e fiabilidade dos dados para análise por equipas de investigação.'}
    }
  ],
  skills: [
    {icon:'🎓', en:'English Teaching & Lesson Planning', pt:'Ensino de Inglês & Planificação'},
    {icon:'💻', en:'Full-Stack Web Development & App Management', pt:'Desenvolvimento Web Full-Stack & Gestão de Apps'},
    {icon:'📝', en:'Translation (English–Portuguese)', pt:'Tradução (Inglês–Português)'},
    {icon:'🤖', en:'AI Tool Integration & Critical Thinking in the AI Era', pt:'Integração de IA & Pensamento Crítico na Era da IA'},
    {icon:'📞', en:'Customer Service & Call Center Support', pt:'Serviço ao Cliente & Suporte Call Center'},
    {icon:'📱', en:'Social Media Marketing & Brand Management', pt:'Marketing em Redes Sociais & Gestão de Marca'},
    {icon:'🏫', en:'Classroom Management', pt:'Gestão de Sala de Aula'},
    {icon:'📊', en:'Data Collection & Field Research', pt:'Recolha de Dados & Pesquisa de Campo'},
    {icon:'👥', en:'Effective Leadership & Team Coordination', pt:'Liderança Eficaz & Coordenação de Equipa'},
    {icon:'🧩', en:'Problem Solving & Conflict Resolution', pt:'Resolução de Problemas & Mediação de Conflitos'},
  ],
  stats: [
    {n: 6, en: 'Years of Experience', pt: 'Anos de Experiência', icon: '🎓'},
    {n: 200, en: 'Students Taught', pt: 'Estudantes Formados', icon: '👥'},
    {n: 76, en: 'Lessons Created', pt: 'Lições Criadas', icon: '📚'},
    {n: 2, en: 'Languages Spoken', pt: 'Línguas Fluentes', icon: '🌍'},
    {n: 6, en: 'Certifications', pt: 'Certificações', icon: '🏅'},
    {n: 4, en: 'CEFR Levels Covered', pt: 'Níveis CEFR na App', icon: '🏆'},
  ],
  certifications: [
    {icon:'🤖', en:'AI Skills Passport — EY & Microsoft', pt:'Passaporte de Competências em IA — EY & Microsoft', year:'EY · Microsoft'},
    {icon:'🧠', en:'Critical Thinking in the AI Era — HP', pt:'Pensamento Crítico na Era da IA — HP', year:'HP'},
    {icon:'💡', en:'AI for Beginners — HP', pt:'IA para Iniciantes — HP', year:'HP'},
    {icon:'📱', en:'Social Media Marketing — HP', pt:'Marketing em Redes Sociais — HP', year:'HP'},
    {icon:'👥', en:'Effective Leadership — HP', pt:'Liderança Eficaz — HP', year:'HP'},
    {icon:'🏅', en:'English Language Certification (Levels 1–5) — CLCI', pt:'Certificação em Língua Inglesa (Níveis 1–5) — CLCI', year:'CLCI'},
  ],
  socials: {
    facebook: 'https://www.facebook.com/sebastiao.nhamuneque',
    instagram: 'https://www.instagram.com/sebastiao_nhamuneque',
    tiktok: 'https://www.tiktok.com/@sebastiao_nhamuneque',
    linkedin: 'https://www.linkedin.com/in/sebastiao-nhamuneque',
    youtube: 'https://www.youtube.com/@EnglishWithSebastian',
    github: 'https://github.com/sebastiaonhamuneque'
  }
};
