...
const ABOUT_DATA = {
  ...
  role: {en: 'English Teacher · Translator · Interpreter · App Creator', pt: 'Professor de Inglês · Tradutor · Intérprete · Criador da App'},
  ...
  education: [
    {
      en: {degree: 'Bachelor\'s in Translation & Interpretation', school: 'Universidade Eduardo Mondlane (UEM)', year: '2022–Present', note: 'Final-year student specialising in English–Portuguese linguistics, intercultural communication, and academic translation.'},
      pt: {degree: 'Licenciatura em Tradução e Interpretação', school: 'Universidade Eduardo Mondlane (UEM)', year: '2022–Presente', note: 'Estudante finalista especializado em linguística inglês-português, comunicação intercultural e tradução académica.'}
    },
    {
      en: {degree: 'Secondary Education (STEM + Humanities)', school: 'Escola Secundária', year: '2016–2021', note: 'Strong foundation in sciences and humanities, with early interest in languages and cross-cultural communication.'},
      pt: {degree: 'Ensino Secundário (Ciências + Humanidades)', school: 'Escola Secundária', year: '2016–2021', note: 'Sólida base em ciências e humanidades, com interesse precoce em línguas e comunicação intercultural.'}
    }
  ],
  experience: [
    {
      en: {title: 'Creator — English With Sebastian App', org: 'Self-built · EWS', period: '2024–Present', desc: 'Designed and developed a bilingual English learning PWA from scratch. Built all lesson content (76 lessons across A0–B1), grammar lab, sound lab, gamification system, AI tutor integration, and cloud sync via Supabase.'},
      pt: {title: 'Criador — Aplicação English With Sebastian', org: 'Construído de raiz · EWS', period: '2024–Presente', desc: 'Desenvolveu uma PWA bilingue de aprendizagem de inglês do zero. Criou todo o conteúdo (76 lições A0–B1), laboratório de gramática, laboratório de sons, gamificação, IA tutora e sincronização via Supabase.'}
    },
    {
      en: {title: 'English Teacher (Levels 1–4)', org: 'CLCI — Consultoria Linguística e Coaching Isac', period: '2020–2024', desc: 'Taught English from beginner to upper-intermediate to diverse adult groups. Developed curriculum, lesson plans, and bespoke assessment tools. Known for high student engagement and measurable progress.'},
      pt: {title: 'Professor de Inglês (Níveis 1–4)', org: 'CLCI — Consultoria Linguística e Coaching Isac', period: '2020–2024', desc: 'Leccionou inglês do nível iniciante ao pré-avançado a grupos diversificados de adultos. Desenvolveu currículo, planos de aula e ferramentas de avaliação personalizadas. Reconhecido pelo alto envolvimento dos estudantes e progressos mensuráveis.'}
    },
    {
      en: {title: 'Freelance Translator & Interpreter EN↔PT', org: 'Freelance / Various Clients', period: '2022–Present', desc: 'Technical, academic and legal translation. Consecutive interpretation for conferences and NGO meetings. Specialisation in education, development sector and linguistic research documents.'},
      pt: {title: 'Tradutor & Intérprete Freelancer EN↔PT', org: 'Freelancer / Vários Clientes', period: '2022–Presente', desc: 'Tradução técnica, académica e jurídica. Interpretação consecutiva em conferências e reuniões de ONGs. Especialização em educação, sector do desenvolvimento e documentos de investigação linguística.'}
    }
  ],
  skills: [
    {icon:'🎓', en:'English Teaching (A0–C1)', pt:'Ensino de Inglês (A0–C1)'},
    {icon:'📝', en:'Translation (EN↔PT)', pt:'Tradução (EN↔PT)'},
    {icon:'🎙️', en:'Consecutive Interpretation', pt:'Interpretação Consecutiva'},
    {icon:'💻', en:'Web App Development', pt:'Desenvolvimento de Apps Web'},
    {icon:'🌍', en:'Localisation & Multilingual UX', pt:'Localização e UX Multilingue'},
    {icon:'📱', en:'Educational Technology', pt:'Tecnologia Educacional'},
    {icon:'🗣️', en:'Content Creation & Social Media', pt:'Criação de Conteúdo e Redes Sociais'},
    {icon:'📊', en:'Language Assessment & Curriculum Design', pt:'Avaliação Linguística e Design Curricular'},
    {icon:'🤖', en:'AI Tool Integration', pt:'Integração de Ferramentas de IA'},
    {icon:'🧩', en:'Gamification & Learner Engagement', pt:'Gamificação e Motivação do Estudante'},
  ],
  stats: [
    {n: 5, en: 'Years Teaching', pt: 'Anos de Ensino', icon: '🎓'},
    {n: 200, en: 'Students Taught', pt: 'Estudantes Formados', icon: '👥'},
    {n: 76, en: 'Lessons Created', pt: 'Lições Criadas', icon: '📚'},
    {n: 3, en: 'Languages Spoken', pt: 'Línguas Faladas', icon: '🌍'},
    {n: 13, en: 'Grammar Topics', pt: 'Tópicos de Gramática', icon: '📖'},
    {n: 4, en: 'Levels (A0→B1+)', pt: 'Níveis (A0→B1+)', icon: '🏆'},
  ],
  certifications: [
    {icon:'🏅', en:'Certified English Teacher — CLCI', pt:'Professor Certificado de Inglês — CLCI', year:'2020'},
    {icon:'🎓', en:'Bachelor\'s Candidate — Translation & Interpretation (UEM)', pt:'Candidato a Licenciado — Tradução e Interpretação (UEM)', year:'2022–Present'},
    {icon:'💻', en:'Self-taught Full-Stack Web Developer (PWA, JS, Supabase)', pt:'Programador Web Auto-didacta (PWA, JS, Supabase)', year:'2024'},
  ],
  socials: {
