...
(function () {
  ...
  // a11y/SEO: proper BCP-47 tags for <html lang>, mirrored from index.html's
  // Phase 1.5 first-paint detection so both stay in sync. Kept as a separate
  // map from LOCALE_GLOBAL_MAP/file names since those use short internal
  // codes (e.g. 'mz', 'pt') that aren't valid lang tags on their own.
  const HTML_LANG_MAP = {
    'en': 'en', 'en-gb': 'en-GB', 'mz': 'pt-MZ', 'pt': 'pt-BR', 'pt-pt': 'pt-PT',
  };
