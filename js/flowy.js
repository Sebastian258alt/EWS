...
//    - New tab tips: lesson / premium / placement (EN + PT)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62 62" width="62" height="62" aria-hidden="true">
  ...
  const TAB_TIPS = {
    en: {
      ...
      premium: {
        entry: [
          'Premium time! ⭐ Let\'s unlock your full potential!',
          'Thinking about Premium? Smart move! 💎',
          'You found the Premium page! 🔓 Great taste!',
        ],
        tips: [
          'Premium = 141 lessons unlocked. All of them. 🗝️',
          'M-Pesa / E-Mola accepted — easy payment! 📱',
          'One payment, lifetime access. Not bad! 💎',
          'Free plan is good. Premium plan is legendary. 👑',
          'Premium unlocks ALL CEFR levels from A1 to C1 🏆',
          'Stuck on the free tier? Premium is the answer 🔓',
        ],
      },
    ...
    pt: {
      ...
      premium: {
        entry: [
          'Hora do Premium! ⭐ Vamos desbloquear o teu potencial total!',
          'A pensar em Premium? Boa decisão! 💎',
          'Encontraste a página Premium! 🔓 Excelente gosto!',
        ],
        tips: [
          'Premium = 141 lições desbloqueadas. Todas elas. 🗝️',
          'M-Pesa / E-Mola aceito — pagamento fácil! 📱',
          'Um pagamento, acesso para sempre. Não é mau! 💎',
          'O plano gratuito é bom. O Premium é lendário. 👑',
          'Premium desbloqueia TODOS os níveis CEFR de A1 a C1 🏆',
          'Preso no nível gratuito? O Premium é a resposta 🔓',
        ],
      },
      // NEW: placement test tab
      placement: {
