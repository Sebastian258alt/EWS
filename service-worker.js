...
const CACHE_NAME = 'ews-v16'; // ← v16: PERF AUDIT — (1) fixed missing <link> for overlays-fx-deferred.css /
// overlays-responsive-deferred.css (was precached but never linked in index.html since v15, so XP-popup/
// confetti/emoji-pop/disco + quiz/lesson/game/grammar/sounds/settings/about-creator responsive rules were
// not rendering); (2) re-encoded all PNG icons/logos with a 256-colour adaptive palette (lossless-looking,
// ~85-93% smaller — icon-512.png 227KB→16KB) and creator.jpg as progressive JPEG. Cache name bumped so
// clients actually fetch the corrected/smaller shell assets instead of serving stale ones.
...
const SHELL_ASSETS = [
  ...
  '/css/overlays-fx.css',
  '/css/overlays-fx-deferred.css',
  '/css/overlays-responsive.css',
  '/css/overlays-responsive-deferred.css',
